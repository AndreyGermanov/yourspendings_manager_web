 ...
 */
export default class ReportListContainer extends EntityListContainer {
    ...
    static getComponent() {
        const list = new ReportListContainer();
        return connect(list.mapStateToProps.bind(list),list.mapDispatchToProps.bind(list))(List.Report);
    }
}