 ...
 */
export default class DiscountListContainer extends EntityListContainer {
    ...
    static getComponent() {
        const list = new DiscountListContainer();
        return connect(list.mapStateToProps.bind(list),list.mapDispatchToProps.bind(list))(List.Discount);
    }
}